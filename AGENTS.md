...
This project carries a set of Sulu 3.0 skills under `skills/`. Each is a short document
covering one task, with verified background material in its `references/` folder. Read a
skill when its trigger applies; don't read them all up front, and pull a reference file
only when the skill points you at it.
...
| `sulu-extend-entity` | adding fields/tabs/behavior to Sulu's own entities: contact, account, user, category, excerpt tab | `skills/sulu-extend-entity/SKILL.md` |
